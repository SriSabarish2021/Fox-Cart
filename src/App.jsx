    ...
    <div className='app'/*  style={{display:loadscreen?'flex':'none'}} */ >
      <Routes>
        <Route path='/' >
            ...
            <Route path='/itemviewall' element={<Viewallitem getparticularname={getparticularname} setfooter={setfooter}  sethrtfunc={sethrtfunc} setcart={setcart} getnameinarr={getnameinarr} setviewbox={setviewbox}  pad={30} height={'auto'} setarr={setarr} arr={arr}/>}/>
