    ...
    <div className='app'/*  style={{display:loadscreen?'flex':'none'}} */ >
      <Routes>
        <Route path='/' >
            ...
            <Route path='/easter' element={ <Subsection sethrtfunc={sethrtfunc} setcart={setcart} getparticularname={getparticularname} arrayforallitems={arrayforallitems} setarrayforallitems={setarrayforallitems} addresscont={addresscont} setaddresscont={setaddresscont} setpinnum={setpinnum} pinnum={pinnum} setinpcity={setinpcity} inpcity={inpcity} setinpstate={setinpstate} inpstate={inpstate} setinpphone={setinpphone} inpphone={inpphone} setaddress={setaddress} inpaddress={inpaddress} inpname={inpname} setinpname={setinpname} setlikedisp={setlikedisp}  setfooter={setfooter}   getnameinarr={getnameinarr} setviewbox={setviewbox}  pad={30} height={'auto'} setarr={setarr} arr={arr}/> }/>
