...
const LikePage = ({likedis,viewbox,setlikedisp,arr,setarr,commentboxshow,shareboxshow,questboxshow}) => {
  ...
  return (
    <div className={`liker ${likedis?'move':'remove'}`} >
      <style>{
        `html{
          overflow-x: hidden;
          overflow-y:${likedis||viewbox||commentboxshow||shareboxshow||questboxshow?'hidden':'auto'}
        }`}
        </style>
