...
const HomeandKitchendec = ({arr,setarr,setviewbox, getnameinarr, setcart, sethrtfunc}) => {
  ...
  return (
    <div className='decors-container'>
      ...
      <div style={{width:'100%'}}>
        <Listofitems sethrtfunc={sethrtfunc} setcart={setcart} getnameinarr={getnameinarr} setviewbox={setviewbox} title={Furn} pad={30} height={'auto'}  setarr={setarr} arr={arr}/>
      </div>
      ...
      <div style={{width:'100%'}}>
        <Listofitems sethrtfunc={sethrtfunc} setcart={setcart} getnameinarr={getnameinarr} setviewbox={setviewbox} title={Furn} pad={30} height={'auto'}  setarr={setarr} arr={arr}/>
        <Twocont sethrtfunc={sethrtfunc} setcart={setcart}  getnameinarr={getnameinarr} setarr={setarr} arr={arr}/>
        <Listofitems sethrtfunc={sethrtfunc} setcart={setcart} getnameinarr={getnameinarr} setviewbox={setviewbox} title={Furn} pad={30} height={'auto'}  setarr={setarr} arr={arr}/>
      </div>
    </div>
  )
